...
background-image:url('theatre.jpg');overflow-x:hidden;
}
h2 {
color:yellow;
...
.lightbox {
 ...
 background: linear-gradient(rgba(5,5,5,.7), rgba(5,55,25,.5)), url("bgr1.jpg");
...
<a href="#image1" class="wiggle"><img src="booknow1.jpg" id="ii"name="m" /></a>
 <div class="lightbox short-animate" id="image1">
    ...
    <CENTER><H1><font face="Garamond" color="white"><?php echo $_GET['theatre_select'];?></H1></CENTER></font>
<br><br>
...
<br>
 ...
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
 <font face=" Bookman" color="black"><input type="submit" name="pay_btn" value="Pay" style="width:150px;margin-left:150px; color:white; font-family:comic sans MS; font-size:150%; background-color:Transparent;"></font>
</form>
...
<td><a href="about_us.html#hiba"  style="text-decoration:none;color:yellow;">Hiba Hussain</td></tr></a>
<tr>
...
<td><a href="about_us.html#mahima"  style="text-decoration:none;color:yellow;">Mahima Gupta</td></a>
<td>Blog</td></tr>
