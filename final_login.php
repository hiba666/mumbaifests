...
#one{position:relative;left:300px;background: rgba(10, 50, 80, 0.5);width:600px;height:400px;font-family: Arial, Helvetica, sans-serif;}
...
#one{position:relative;left:30px;background: rgba(10, 50, 80, 0.5);width:300px;height:350px;font-family: Arial, Helvetica, sans-serif;}
footer{width:360px;
background-color:#333;
}
	}
...
#one{position:relative;left:150px;background: rgba(10, 50, 80, 0.5);width:300px;height:300px;font-family: Arial, Helvetica, sans-serif;}
footer{width:700px;
background-color:#333;
}
	}
...
<body>
<header><div class="container"><center>
       <img src="bghhh.jpg"id="headbb"></center>
</div>
        <div class="navbar">
